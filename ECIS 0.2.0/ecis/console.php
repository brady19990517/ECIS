...
if (isset($_COOKIE["user"]) and $_COOKIE["type"]=="admin")
{
    ...
    <body onload='list_user("$user");'>
            ...
            <div class="top-bar__right">
                <div class="drop-list--hover">
                    ...
                    <div class="drop-list__menu">
                        <a class="drop-list__item" onClick="changepasswd('$user');">password</a>
        ...
        <div class="side-bar">
            <a class="side-bar__link" onClick="setTimeout(function(){window.location.href='/ecis/manageact.php';},0);">Manage Activities</a>
            <a class="side-bar__link--chosen">Manage Users</a>
            <a class="side-bar__link">$explaination</a>
        </div>    
        <div class="main-area">
